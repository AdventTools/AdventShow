...
![version](https://img.shields.io/badge/versiune-1.1.2-green)
...
|-----------|---------------------|
| **Windows** | [`AdventShow-Windows-1.1.2-Setup.exe`](https://github.com/AdventTools/AdventShow/releases/latest) |
| **macOS** | [`AdventShow-Mac-1.1.2-Installer.dmg`](https://github.com/AdventTools/AdventShow/releases/latest) |
| **Linux** | [`AdventShow-Linux-1.1.2.AppImage`](https://github.com/AdventTools/AdventShow/releases/latest) |
