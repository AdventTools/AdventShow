...
![version](https://img.shields.io/badge/versiune-1.3.7-green)
...
| Platformă | Descarcă |
|-----------|----------|
| **Windows** | [AdventShow-Setup.exe](https://github.com/AdventTools/AdventShow/releases/download/v1.3.7/AdventShow-Setup.exe) |
| **macOS** | [AdventShow-Mac-1.3.7.dmg](https://github.com/AdventTools/AdventShow/releases/download/v1.3.7/AdventShow-Mac-1.3.7.dmg) |
| **Linux** | [AdventShow-Linux.AppImage](https://github.com/AdventTools/AdventShow/releases/download/v1.3.7/AdventShow-Linux.AppImage) |
