...
![version](https://img.shields.io/badge/versiune-1.2.7-green)
...
| Platformă | Descarcă |
|-----------|----------|
| **Windows** | [AdventShow-Setup.exe](https://github.com/AdventTools/AdventShow/releases/download/v1.2.7/AdventShow-Setup.exe) |
| **macOS** | [AdventShow-Mac-1.2.7.dmg](https://github.com/AdventTools/AdventShow/releases/download/v1.2.7/AdventShow-Mac-1.2.7.dmg) |
| **Linux** | [AdventShow-Linux.AppImage](https://github.com/AdventTools/AdventShow/releases/download/v1.2.7/AdventShow-Linux.AppImage) |
